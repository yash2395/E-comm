                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th colspan="3" class="text-right">
                                            Discount:{{ !empty($order->coupon_code) ? $order->coupon_code : '' }}</th>
                        ...
                        <form action="" method="post" name="changeOrderStatusForm" id="changeOrderStatusForm">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input placeholder="Shipped" value="{{$order->shipped_date}}" type="text" name="shipped_date" id="shipped_date" class="form_control">
                                </div>
                                <div class="mb-3">
